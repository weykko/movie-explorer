package ru.urfu.movie_explorer.data.network
...
import ru.urfu.movie_explorer.BuildConfig
import ru.urfu.movie_explorer.data.network.api.ImdbApi
import java.util.concurrent.TimeUnit

/**
 * Фабрика сетевых клиентов.
 *
 * Собирает OkHttp с интерцепторами (logging + Chucker) и Retrofit с
 * kotlinx.serialization-конвертером.
 */
